...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link me-4" href="#mobile-products">Smartphone</a>
              </li>
              <li class="nav-item">
            ...
            <div class="row d-flex align-items-center">
              <div class="col-md-6">
                <div class="banner-content">
                  ...
                  <a href="shop.html" class="btn btn-medium btn-light text-uppercase btn-rounded-none">Shop Product</a>
                </div>
              </div>
              <div class="col-md-5">
        ...
        <div class="col-lg-3 col-md-6 pb-3">
          <div class="icon-box d-flex">
            ...
            <div class="icon-box-content">
              ...
              <p>Our customer support is available around the clock, 24/7. Enjoy a worry-free shopping experience with
        ...
        <div class="col-lg-3 col-md-6 pb-3">
          <div class="icon-box d-flex">
            ...
            <div class="icon-box-content">
              ...
              <p>If you’re not satisfied with the product, we offer a 30-day money-back guarantee with no questions
                asked.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 pb-3">
          <div class="icon-box d-flex">
            ...
            <div class="icon-box-content">
              ...
              <p>We provide a 1-year product warranty to ensure your satisfaction and the quality of your purchase. Shop
        ...
        <div class="col-lg-3 col-md-6 pb-3">
          <div class="icon-box d-flex">
            ...
            <div class="icon-box-content">
              ...
              <p>We care about the environment. All of our products are packaged with eco-friendly materials, ensuring
        ...
        <div class="col-lg-3 col-md-6 pb-3">
          <div class="icon-box d-flex">
            ...
            <div class="icon-box-content">
              ...
              <p>Join our membership program and gain access to exclusive offers, special discounts, and early access to
                new products.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 pb-3">
          <div class="icon-box d-flex">
            ...
            <div class="icon-box-content">
              ...
              <p>Need your items faster? Enjoy our express shipping service to get your products delivered on time.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 pb-3">
          <div class="icon-box d-flex">
            ...
            <div class="icon-box-content">
              ...
              <p>Returning a product is easy with our hassle-free return policy. Simply follow the steps, and we’ll
    ...
    <div class="container">
      <div class="row">
        <div class="display-header d-flex justify-content-between pb-3">
          ...
          <div class="btn-right">
            <a href="shop.html" class="btn btn-medium btn-normal text-uppercase text-white">Go to Shop</a>
          </div>
        </div>
    ...
    <div class="row d-flex flex-wrap align-items-center">
      <div class="col-md-6 col-sm-12">
        <div class="text-content offset-4 padding-medium">
          ...
          <a href="shop.html" class="btn btn-medium btn-light text-uppercase btn-rounded-none">Shop Sale</a>
        </div>
      </div>
      <div class="col-md-6 col-sm-12">
  ...
  <section id="latest-blog" class="padding-large">
    <div class="container">
      <div class="row">
        <div class="display-header d-flex justify-content-between pb-3">
          <h2 class="display-7 text-white text-uppercase">Latest Posts</h2>
          <div class="btn-right">
            <a href="blog.html" class="btn btn-medium btn-normal text-uppercase text-white">Read Blog</a>
          </div>
        </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide text-center text-white d-flex justify-content-center">
                <div class="review-item col-md-10">
                  ...
                  <blockquote>“B-Store is absolutely amazing! I was so impressed with the fast delivery and the
                    quality of the products they offer. Their customer service team is super friendly and always ready
                  ...
                  <div class="author-detail">
                    <div class="name text-white text-uppercase pt-2">Riyanda Cavin Sinambela, Security Engineer</div>
                  </div>
                </div>
              </div>
              <div class="swiper-slide text-center text-white d-flex justify-content-center">
                <div class="review-item col-md-10">
                  <i class="icon icon-review"></i>
                  <blockquote>“Shopping at B-Store was incredibly easy and enjoyable. The products are high quality,
                    and the prices are very competitive. I also love the express shipping option, which made everything
                  ...
                  <div class="author-detail">
                    <div class="name text-white text-uppercase pt-2">Richard Sitanggang, Network Security Operations
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row d-flex flex-wrap justify-content-between text-white">
            <div class="col-lg-3 col-sm-6 pb-3">
              <div class="footer-menu">
                <span>B-Store</span>
                <p>BatakStore delivers quality, affordable, innovative products with fast delivery, secure payments,
                  eco-friendly
        ...
        <div class="col-md-4 col-sm-6">
          <div class="Shipping d-flex">
            ...
            <div class="card-wrap ps-2">
              <img src="images/jne.png" height="15" width="auto" alt="jne express">
              <img src="images/ninja.png" height="15" width="auto" alt="ninja xpress">
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6">
